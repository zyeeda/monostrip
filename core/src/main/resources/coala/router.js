...
(function() {
  ...
  callHook = function() {
    var action, args, formName, hook, hookType, name, options, request;
    hookType = arguments[0], action = arguments[1], formName = arguments[2], options = arguments[3], request = arguments[4], args = 6 <= arguments.length ? __slice.call(arguments, 5) : [];
    if (!options.hooks) {
      return true;
    }
