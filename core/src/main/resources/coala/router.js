...
(function() {
  ...
  defaultHandlers = {
    list: function(options, service, entityMeta, request) {
      var configs, count, entity, o, orders, pageSize, restricts, result;
      result = {};
