...
(function() {
  var ProcessStatusAware, createProcessService, createService, mark, type,
    __slice = [].slice;
  ...
  ProcessStatusAware = com.zyeeda.framework.entities.base.ProcessStatusAware;
  ...
  exports.createService = function(entityClass, entityMeta) {
    ...
    service = {
      ...
      create: mark('tx').on(function(entity) {
        var manager, processId, processInstance, processSession;
        manager = baseService.createManager(service.entityClass);
