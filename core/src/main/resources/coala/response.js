...
(function() {
  var ObjectMapper, SerializationConfig, SimpleBeanPropertyFilter, SimpleDateFormat, SimpleFilterProvider, buildObjectMapper, charset, coala, getContentType, log, objects, res, type, _ref, _ref1, _ref2,
    __slice = [].slice,
  ...
  _ref1 = org.codehaus.jackson.map, ObjectMapper = _ref1.ObjectMapper, SerializationConfig = _ref1.SerializationConfig;

  _ref2 = org.codehaus.jackson.map.ser.impl, SimpleFilterProvider = _ref2.SimpleFilterProvider, SimpleBeanPropertyFilter = _ref2.SimpleBeanPropertyFilter;
  ...
  */
  ...
  exports.json = function(object, config) {
    var contentType, k, result, v, _ref3, _ref4;
    ...
    result = {
      ...
      forEach: function(fn) {
        ...
        if (this._jsonResult == null) {
          mapper = buildObjectMapper(this._included, this._excluded, result);
      ...
      asStream: function(request) {
        ...
        return exports.stream(request, {
          ...
          body: function(stream) {
            var mapper;
            mapper = buildObjectMapper(_this._included, _this._excluded, result);
    ...
    if (config != null) {
      _ref3 = config.include;
      for (k in _ref3) {
        v = _ref3[k];
        result.include(k, v);
      }
      _ref4 = config.exclude;
      for (k in _ref4) {
        v = _ref4[k];
        result.exclude(k, v);
      }
  ...
  buildObjectMapper = function(included, excluded, result) {
    var df, filter, k, mapper, v;
    ...
    df = new SimpleDateFormat(result.dateFormat || coala.dateFormat);
