...
(function() {
  var ArrayList, Boolean, Class, Configuration, Context, Date, DatetimeUtils, Double, EntityManager, EntityManagerFactory, EntityManagerFactoryUtils, Example, Integer, MatchMode, Order, Projections, Restrictions, String, coala, context, createQuery, createUtil, entityMetaResolver, fillPageInfo, firstIfOnlyOne, fs, getEntityManager, getPageInfo, loadOrms, modified, modifyRecord, namedQueries, objects, type, _ref, _ref1, _ref2, _ref3, _ref4,
    __slice = [].slice;
  ...
  exports.createManager = function(entityClass, name) {
    ...
    return {
      ...
      findByExample: function(example, option) {
        var dsFiles, dsPath, managerUtil, meta, path, paths, _i, _ref5;
        if (option == null) {
          option = {};
        }
