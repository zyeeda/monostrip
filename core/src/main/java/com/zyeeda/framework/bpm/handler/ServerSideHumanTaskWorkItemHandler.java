...
public class ServerSideHumanTaskWorkItemHandler implements WorkItemHandler {
    ...
    public void setHumanTaskService(
            org.jbpm.task.service.TaskService humanTaskService) {
    ...
    public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
        ...
        org.jbpm.task.TaskService service = new LocalTaskService(
    ...
    protected Task createTask(WorkItem workItem) {
        ...
        if ((this.ksession != null)
                && (this.ksession.getProcessInstance(workItem
                        .getProcessInstanceId()) != null)) {
            taskData.setProcessId(this.ksession
                    .getProcessInstance(workItem.getProcessInstanceId())
                    .getProcess().getId());
        }

        if ((this.ksession != null)
                && ((this.ksession instanceof StatefulKnowledgeSession))) {
            taskData.setProcessSessionId(((StatefulKnowledgeSession) this.ksession)
                    .getId());
        }
