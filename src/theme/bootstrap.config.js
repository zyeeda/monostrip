...
module.exports = {
  ...
  preBootstrapCustomizations: './src/theme/_pre-bootstrap-customizations.scss',
  ...
  bootstrapCustomizations: './src/theme/_bootstrap-customizations.scss',

  mainSass: './src/theme/_bootstrap-main.scss',
